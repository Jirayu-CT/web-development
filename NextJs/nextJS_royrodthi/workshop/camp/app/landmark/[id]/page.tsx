...
import FavoritToggleButton from "@/components/card/FavoritToggleButton"
...
const LandmarkDetail = async ({ params }: { params: { id: string } }) => {
  ...
  const landmark = await fetchLandmarkDetail({ id: id })
    ...
    <section>
      ...
      <header className="flex justify-between mt-4 items-center">
        ...
        <div className="flex items-center gap-x-4">
          ...
          <FavoritToggleButton landmarkId={landmark.id} />
        </div>
      </header>
      {/* Image */}
